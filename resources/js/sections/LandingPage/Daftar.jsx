...
const Daftar = () => {
  return (
    <section className='py-10 container mx-auto space-y-4 flex flex-col items-center'>
      ...
      <p className='font-jakarta text-2xl text-center  font-light text-primary500'>Jangan lewatkan lomba-lomba dan forum daerah</p>
      <img src={Dekorasi} draggable='false' alt="dekorasi" className='mx-auto' />
      <motion.button 
      whileTap={{scale:0.95}}
      
      className='px-8 py-2 rounded-3xl hover:bg-primary300 duration-300 ease-in-out bg-primary500 text-white font-jakarta text-xl '>Daftar Sekarang</motion.button>
    </section>
  )
}
